// Inline SVG icons matching the DevTools panel UI, sized for use in prose text.
// Each icon is a 16×16 inline SVG with currentColor so it inherits text color.
...
export function RefreshIcon() {
  return (
    <span
      style={{ ...style, fontSize: "16px", fontWeight: 500, lineHeight: 1 }}
    >
      ↻
    </span>
  );
...
export function CloseIcon() {
  return (
    <span
      style={{ ...style, fontSize: "14px", fontWeight: 500, lineHeight: 1 }}
    >
      ✕
    </span>
  );
...
export function OverflowIcon() {
  return (
    <span
      style={{ ...style, fontSize: "14px", fontWeight: 600, lineHeight: 1 }}
    >
      »
    </span>
  );
