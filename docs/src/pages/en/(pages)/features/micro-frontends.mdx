...
> **Note:** React Server Components, client components and server functions are all supported in micro-frontends when using `@lazarv/react-server` with server-side rendering.
...
export default {
  importMap: {
    imports: {
      react: "https://esm.sh/react@0.0.0-experimental-404b38c7-20260408?dev",
      "react/jsx-dev-runtime":
        "https://esm.sh/react@0.0.0-experimental-404b38c7-20260408/jsx-dev-runtime?dev",
      "react/jsx-runtime":
        "https://esm.sh/react@0.0.0-experimental-404b38c7-20260408/jsx-runtime?dev",
      "react-dom":
        "https://esm.sh/react-dom@0.0.0-experimental-404b38c7-20260408?dev",
      "react-dom/client":
        "https://esm.sh/react-dom@0.0.0-experimental-404b38c7-20260408/client?dev",
      "react-server-dom-webpack/client.browser":
        "https://esm.sh/react-server-dom-webpack@0.0.0-experimental-404b38c7-20260408/client.browser?dev",
    },
  },
};
```
...
export default {
  importMap: {
    imports: {
      react: "https://esm.sh/react@0.0.0-experimental-404b38c7-20260408",
      "react/jsx-runtime":
        "https://esm.sh/react@0.0.0-experimental-404b38c7-20260408/jsx-runtime",
      "react-dom":
        "https://esm.sh/react-dom@0.0.0-experimental-404b38c7-20260408",
      "react-dom/client":
        "https://esm.sh/react-dom@0.0.0-experimental-404b38c7-20260408/client",
      "react-server-dom-webpack/client.browser":
        "https://esm.sh/react-server-dom-webpack@0.0.0-experimental-404b38c7-20260408/client.browser",
    },
  },
};
```
