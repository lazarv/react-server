...
You can also access the full [HTTP context](/framework/http) during server-side rendering, middlewares, route handlers or server functions. The framework provides a set of hooks and functions to access and manipulate the HTTP context.
