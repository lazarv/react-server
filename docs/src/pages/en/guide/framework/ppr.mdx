...
To enable partial pre-rendering, you will also need to export your pre-rendered pages as static pages. To do so, add `export` to your `react-server.config.mjs`. See more details about static exporting at [Static generation](/guide/router/static).
