...
The runtime ships with [React](/integrations/react) built-in — you don't need to install `react` or `react-dom` yourself, and third-party React libraries work out of the box thanks to automatic module aliasing.

When you want to use TypeScript or Tailwind CSS with `@lazarv/react-server`, you can learn how to configure [TypeScript](/integrations/typescript) and how to install and configure [Tailwind CSS](/integrations/tailwind-css) to work with this runtime.
