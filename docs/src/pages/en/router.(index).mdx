...
The `@lazarv/react-server` runtime includes a file-system based router which is building on top of the runtime's own low-level routing solutions and it's very easy to use and configure. If you think this router is too much for your needs, you can use the built-in low-level [server-side router](/router/server-routing) and [client-side navigation](/router/client-navigation) components or use a third-party router like [React Router](https://reactrouter.com/) or [TanStack Router](https://tanstack.com/router). You can check out the [examples](https://github.com/lazarv/react-server/tree/main/examples) collection on how to use these third-party routers.
